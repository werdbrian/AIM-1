...
namespace AIM.Autoplay.Util.Helpers
{
    internal class MetaHandler
    {
        public static string[] Supports =
        {
            ...
            "Kayle", "Leona", "Lulu", "Morgana", "Nunu", "Nami", "Soraka", "Sona", "Taric", "Thresh", "Zilean", "Zyra", "Bard"
        };

        public static string[] AP =
        {
            "Ahri",  "Alistar", "Anivia", "Annie", "Azir", 
            "Brand", "Braum", "Cassiopeia", "Chogath", "Diana", "Ekko", "Elise", "Evelynn", "ezreal", "FiddleSticks", "Fizz",
